...
import "./MutatingWebhookConfigurationChart.css";
...
@observer
export class MutatingWebhookConfigurationChart extends React.Component<
...
> {
  ...
  async componentWillReceiveProps(
    nextProps: Renderer.Component.KubeObjectDetailsProps<MutatingWebhookConfiguration>
  ) {
    //展示图表
      ...
      if (
        ...
        if (toServiceObject) {
          ...
          linkDataArray.push({
            ...
            text: webhook["name"]+":"+webhook["clientConfig"]["service"]["path"],
          });
        }
      }
    }
